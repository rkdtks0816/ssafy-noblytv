...
public class JwtAuthenticationFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (requestURI.equals("/users/family/login") || requestURI.equals("/users/family/signup") || requestURI.equals("/users/old/signup")
                || requestURI.startsWith("/tv/login") || requestURI.startsWith("/users/family/duplication/") || requestURI.startsWith("/swagger-ui/") || requestURI.startsWith("/v3/") || requestURI.startsWith("/api-docs/") || requestURI.startsWith("/swagger-resources/") || requestURI.startsWith("/quiz/"))  {
