...
import { SeniorInfoT, LunarSolar } from './SeniorSignUpType';
import seniorInfoInit from './SeniorSignUpConstants';
...
function SeniorBirth() {
  ...
  const [seniorInfo, setSeniorInfo] = useState<SeniorInfoT>(seniorInfoInit);
  ...
  const handleSubmit = () => {
    // 다음 페이지 구현 필요
    navigate('/senior-sign-up/unique-code');
  };
